                            ...
                            <div className='row d-flex first_vertical_slider_slide1 '>
                                <div className='col-md-7 col-lg-7 col-xl-7 col-12 '>
                                    <div className='verticalslide1Head col-12'>
                                        <p className={currentPageIndex == 0 ? "verticalslide1Head-text animate__animated animate__fadeInUp time1 " : "verticalslide1Head-text"} >
                            ...
                            <div className='row'>
                                <div className='col-md-12 col-lg-7 col-xl-7 col-12'>
                                    <div className='vertical-slide2-img'>
                                        <img className={currentPageIndex == 1 ? 'vert1-slide2-img animate__animated animate__fadeIn ':" vert1-slide2-img"} src={fab_uk} />
                                    </div>
                                </div>
                                <div className='col-md-12 col-lg-5 col-xl-5 col-12'>
                                    <div className={currentPageIndex == 1 ? "verticalslide1Head_1 animate__animated animate__fadeInUp time1" : ""}>
                                        <p className='scaleknoledge'>Scale as a Knowledge Partner</p>
                                    </div>
                                    <div className={currentPageIndex == 1 ? "verticalslide1Head_1 animate__animated animate__fadeInUp time2" : ""}>
                    ...
                    <div className='vertical2-slide d-flex justi'>
                        <div className='col-12 '>
                            <div className='row d-flex upper-content-3rdslide'>
                                <div className={currentPageIndex == 2 ? "col-md-12 col-xl-5 col-lg-5 col-12 animate__animated animate__fadeInUp time1 " : "col-md-5 col-xl-5 col-lg-5 col-12"} >
                                    <p className='uppercontent-head'>Transform higher education in Haryana</p>
                                </div>
                                <div className={currentPageIndex == 2 ? "col-md-12 col-xl-7 col-lg-7 col-12 animate__animated animate__fadeInUp time2" : "col-md-7 col-xl-7 col-lg-7 col-12"} >
                                    ...
                                    <div className="row   d-flex justify-content-center">
                                        <div className="col-xl-4 col-lg-4 col-md-12">
                                            <div className="border-0 h-100 mr-2">
                                                <img src={fab_uk} className={currentPageIndex == 2 ? "card-img-top small-image-vertical2 animate__animated animate__fadeInUp time3" : "card-img-top small-image-vertical2"} alt="..." />
                                                <div className="card-body">
                                                    {/* <h5 className="card-title fw-bold">Card title</h5> */}
                                                    <p className={currentPageIndex == 2 ?"card-text text-center card_3vert2_text animate__animated animate__fadeInUp time4":"card-text text-center card_3vert2_text"}>
                                        ...
                                        <div className="col-xl-4 col-lg-4 col-md-12">
                                            <div className=" border-0 h-100 mx-2">
                                                <img src={fab_uk} className={currentPageIndex == 2 ?"card-img-top small-image-vertical2 animate__animated animate__fadeInUp time5":"card-img-top small-image-vertical2"} alt="..." />
                                                <div className="card-body">
                                                    {/* <h5 className="card-title fw-bold">Card title</h5> */}
                                                    <p className={currentPageIndex == 2 ?"card-text text-center card_3vert2_text animate__animated animate__fadeInUp time6":"card-text text-center card_3vert2_text"}>
                                        ...
                                        <div className="col-xl-4 col-lg-4 col-md-12">
                                            <div className="border-0 h-100 ">
                                                <img src={fab_uk} className={currentPageIndex == 2 ? "card-img-top small-image-vertical2 animate__animated animate__fadeInUp time7":"card-img-top small-image-vertical2"} alt="..." />
                                                <div className="card-body">
                                                    {/* <h5 className="card-title fw-bold">Card title</h5> */}
                                                    <p className={currentPageIndex == 2 ?"card-text text-center card_3vert2_text animate__animated animate__fadeInUp time8":"card-text text-center card_3vert2_text"}>
