        ...
        <>
            <div id="carrerprep" className='' ref={elementRef1}>
                ...
                <div className='carrerprep_1_slide d-flex justify-content-around d-flex '>
                    <div  className={isVisible ?`col-md-4  col-xl-4 col-lg-4 col-6 circle_career_prep mx-md-5 mx-lg-5 mx-xl-5 mx-0 animate__animated  animate__fadeInUp time1  d-flex flex-column time2`:""}>
                    ...
                    <div className={isVisible ? `col-md-4  col-xl-4 col-lg-4 col-6 circle_career_prep mx-md-5 mx-lg-5 mx-xl-5 mx-0 my-2 animate__animated  animate__fadeInUp time2 d-flex flex-column time3`:""}>
                        <p className='yellow-text Career_prep_number BebasNeue'>1200</p>
                        <p className='Career_prep_text Lato'>
                            students took up internships and <br/> full-time jobs
                        </p>
                    </div>
                    <div className={isVisible ? `col-md-4  col-xl-4 col-lg-4 col-6 circle_career_prep mx-md-5 mx-lg-5 mx-xl-5 mx-0 animate__animated  animate__fadeInUp  d-flex flex-column time4`:""}>
                ...
                <div className='carrerprep_2_slide d-flex justify-content-evenly d-flex  '>
                    <div className={isVisible ? `circle_career_prep mx-md-5 mx-lg-5 mx-xl-5 mx-0 animate__animated  animate__fadeInUp  d-flex flex-column time5`:""}>
                        <p className='yellow-text Career_prep_number BebasNeue'>130</p>
                        <p className='Career_prep_text Lato'>
                            teachers built experiential facilitation skills
                        </p>
                    </div>
                    <div className={isVisible ? `circle_career_prep mx-md-5 mx-lg-5 mx-xl-5 mx-0 my-2 animate__animated  animate__fadeInUp  d-flex flex-column time6`:""}>
                ...
                <div className='careerPrep_foot d-flex justify-content-center mt-5'>
                    <p className={isVisible ? 'careerPrep_foot_paraText mt-2 Lato animate__animated  animate__fadeInUp time7':""}>
                        For detailed insights about our impact in 2021-22
                    </p>
                   
                    <span className={isVisible ? 'careerPrep_foot_button yellow-text Lato animate__animated  animate__fadeInUp time8':""}>Read our Impact Report</span>
