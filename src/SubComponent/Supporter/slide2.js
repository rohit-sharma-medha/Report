        ...
        <div className='col-12'>
            <div className='row d-flex align-items-center'>
              <div className='supporter_Heading'>
                ...
                <div className='d-flex justify-content-center flex-md-row flex-xl-row flex-lg-row flex-columm Slide2_images '>
                    <div className='mr-md-3 mr-lg-3 mr-xl-3 mr-0 text-center col-md-3 col-xl-3 col-lg-3 col-5 '>
                        <img className='supporter_img' src={AccentureSqaure}/>
                    </div>
                    <div className='mx-md-3 mx-lg-3 mx-xl-3 mx-0  text-center col-md-3 col-xl-3 col-lg-3 col-5'>
                ...
                <div className='d-flex justify-content-center flex-md-row flex-xl-row flex-lg-row Slide2_images'>
                    <div className=' text-center col-md-3 col-xl-3 col-lg-3 col-6 '>
